...
# Kamus Terjemahan untuk Orang Awam (Lengkap 19 Fitur)
TERJEMAHAN_FITUR = {
    ...
    "SpacialCharRatioInURL": "Proporsi Karakter Spesial (Simbol)",
    "NoOfOtherSpecialCharsInURL": "Jumlah Karakter Spesial (Simbol)",
    "NoOfObfuscatedChar": "Jumlah Karakter yang Disandikan/Disamarkan",
    "HasObfuscation": "Adanya Penyamaran Teks",
    "IsDomainIP": "Penggunaan Alamat IP sebagai Domain",
    "ObfuscationRatio": "Proporsi Karakter Tersamar",
    "NoOfAmpersandInURL": "Jumlah Simbol 'Dan' (&)",
    "NoOfEqualsInURL": "Jumlah Simbol Sama Dengan (=)",
    "NoOfQMarkInURL": "Jumlah Simbol Tanda Tanya (?)"
}
